...
%        display(' Use two segments') % Use two segments
        C = 2;        
    else
        % Use one segment
        C = 1;
...
%     f = e(channel_interleaver_pattern);
    ...
    if C == 2
        ...
        e = polar_encoder(a(1:floor(A/C)), info_bit_pattern2, rate_matching_pattern);
        ...
        e = polar_encoder(a(floor(A/C)+1:A), info_bit_pattern, rate_matching_pattern);

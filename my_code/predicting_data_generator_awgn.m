...
save(['./PredictingData/awgn_a',num2str(K),'_',num2str(N),'_',num2str(Kfactor),'_',num2str(seed)],'codewords','-ascii');
save(['./PredictingData/awgn_llr',num2str(K),'_',num2str(N),'_',num2str(Kfactor),'_',num2str(seed)],'llr','-ascii');
save(['./PredictingData/awgn_a',num2str(K),'_',num2str(N),'_',num2str(Kfactor),'_',num2str(seed)],'decoded_bits','-ascii');

...
test_block_number = 300000;
for block_number = [10000, 50000, 100000, 200000]
...
for EsN0 = EsN0_range
    ...
    model_filename = ['/Users/eoahy/model/awgn_hata','_',num2str(block_number),'_',num2str(EsN0),'.keras'];
    %py_train.train_model(training_llr_filename,training_a_filename,model_filename,int64(epochstime));
    evalute_llr_filename = ['/Users/eoahy/Matlabfile/polar_codes_matlab_fading/PredictingData/fixawgn_llr',num2str(K),'_',num2str(N),'_',num2str(EsN0),'_',num2str(Kfactor),'_',num2str(test_block_number),'_',num2str(evaluate_seed)];
    evaluate_bits_filename = ['/Users/eoahy/Matlabfile/polar_codes_matlab_fading/PredictingData/fixawgn_a',num2str(K),'_',num2str(N),'_',num2str(EsN0),'_',num2str(Kfactor),'_',num2str(test_block_number),'_',num2str(evaluate_seed)];
    results_filename = ['/Users/eoahy/Matlabfile/polar_codes_matlab_fading/results/fixawgnhK_',num2str(K),'_',num2str(N),'_',num2str(EsN0),'_',num2str(Kfactor),'_',num2str(test_block_number),'_',num2str(evaluate_seed)];
...
filename_loss = ['./results/fixawgn_hata_loss_epoch_',num2str(epochstime),'_blnum_',num2str(block_number)];
filename_binary_accuracy = ['./results/fixawgn_hata_accuracy_epoch_',num2str(epochstime),'_blnum_',num2str(block_number)];

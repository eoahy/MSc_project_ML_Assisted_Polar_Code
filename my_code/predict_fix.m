...
for EsN0 = 0:0.5:10
    ...
    save(['./PredictingData/fixawgn_a',num2str(K),'_',num2str(N),'_',num2str(EsN0),'_',num2str(Kfactor),'_',num2str(block_number),'_',num2str(seed)],'codewords','-ascii');
    save(['./PredictingData/fixawgn_llr',num2str(K),'_',num2str(N),'_',num2str(EsN0),'_',num2str(Kfactor),'_',num2str(block_number),'_',num2str(seed)],'llr','-ascii');
    save(['./PredictingData/fixawgn_hata',num2str(K),'_',num2str(N),'_',num2str(EsN0),'_',num2str(Kfactor),'_',num2str(block_number),'_',num2str(seed)],'decoded_bits','-ascii');
end
...
for EsN0 = EsN0_range
    ...
    results_filename = ['/Users/eoahy/Matlabfile/polar_codes_matlab_fading/results/fixawgnK_',num2str(K),'_',num2str(N),'_',num2str(EsN0),'_',num2str(Kfactor),'_',num2str(evaluate_seed)];
...
filename_loss = ['./results/fixawgn_a_loss_K_',num2str(K),'_E_',num2str(E),'_epoch_',num2str(epochstime),'_blnum_',num2str(block_number)];
filename_binary_accuracy = ['./results/fixawgn_a_accuracy_K_',num2str(K),'_E_',num2str(E),'_epoch_',num2str(epochstime),'_blnum_',num2str(block_number)];

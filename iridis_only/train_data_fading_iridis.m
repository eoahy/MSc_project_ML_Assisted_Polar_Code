function train_data_fading_iridis(K, N, E, L, block_number, min_sum, EsN0_start, EsN0_delta, EsN0_end, Kfactor, seed)
...
% complexity.
% example: train_data_fading_iridis(8, 32, 32, 8, 80000, 1, 0, 0.5, 10, 0, 0)
...
for EsN0 = EsN0_start:EsN0_delta:EsN0_end
    filename_a = ['./iridis_train_data/fading_a_K_',num2str(K),'_N_',num2str(N),'_L_',num2str(L),'_blnum_',num2str(block_number),'_',num2str(EsN0),'_',num2str(seed)'];
    filename_hata = ['./iridis_train_data/fading_hata_K_',num2str(K),'_N_',num2str(N),'_L_',num2str(L),'_blnum_',num2str(block_number),'_',num2str(EsN0),'_',num2str(seed)'];
    filename_llr = ['./iridis_train_data/fading_llr_K_',num2str(K),'_N_',num2str(N),'_L_',num2str(L),'_blnum_',num2str(block_number),'_',num2str(EsN0),'_',num2str(seed)'];
